...
object DrawCircle {
    ...
    fun TextView.drawCircle(item: List<Int>) {
        item.forEach {
            if (background == null) {
                when {
                    it == 1 && id == R.id.tv_sunday -> {
                        background = ContextCompat.getDrawable(context, R.drawable.circle_date_red)
                    }
                    it == 2 && id == R.id.tv_monday -> {
                        background =
                            ContextCompat.getDrawable(context, R.drawable.circle_date_black)
                    }
                    it == 3 && id == R.id.tv_tuesday -> {
                        background =
                            ContextCompat.getDrawable(context, R.drawable.circle_date_black)
                    }
                    it == 4 && id == R.id.tv_wednesday -> {
                        background =
                            ContextCompat.getDrawable(context, R.drawable.circle_date_black)
                    }
                    it == 5 && id == R.id.tv_thursday -> {
                        background =
                            ContextCompat.getDrawable(context, R.drawable.circle_date_black)
                    }
                    it == 6 && id == R.id.tv_friday -> {
                        background =
                            ContextCompat.getDrawable(context, R.drawable.circle_date_black)
                    }
                    it == 7 && id == R.id.tv_saturday -> {
                        background = ContextCompat.getDrawable(context, R.drawable.circle_date_blue)
                    }
                }
            }
